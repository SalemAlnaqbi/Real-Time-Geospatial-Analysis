...
> 📍 [**View the live interactive map**](https://htmlpreview.github.io/?https://raw.githubusercontent.com/SalemAlnaqbi/Real-Time-Geospatial-Analysis/main/Project/pilot_map.html) (GitHub renders `.html` files as source code, not as pages, so this link goes through [htmlpreview.github.io](https://htmlpreview.github.io/) to actually run it). Or download [`Project/pilot_map.html`](Project/pilot_map.html) and open it locally, or run `python Project/pilot_map.py` to regenerate it.
>
...
Full methodology, tuning steps, and reasoning are documented in the [notebook](Project/Research_Proposal_and_Pilot_Study.ipynb).
...
📍 [**View the live map**](https://htmlpreview.github.io/?https://raw.githubusercontent.com/SalemAlnaqbi/Real-Time-Geospatial-Analysis/main/Project/pilot_map.html) without cloning the repo.
...
Full risk analysis (three risks + mitigations per phase) is documented in the [notebook](Project/Research_Proposal_and_Pilot_Study.ipynb).
...
*Full reference list available in the [notebook](Project/Research_Proposal_and_Pilot_Study.ipynb).*
